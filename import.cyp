CREATE 
    ...
    (impresija:Accommodation {accommodationId: 1, name: 'Vila na Telepu'}),
    (depresija:Accommodation {accommodationId: 2, name: 'Vila u Krnjaci'}),
    (ravijojla:Accommodation {accommodationId: 3, name: 'Vila na Adicama'}),
    (vukman:Accommodation {accommodationId: 4, name: 'Vila u Kamenici'}),
    (gruborka:Accommodation {accommodationId: 5, name: 'Vila Impresija'}),
    (elena:Accommodation {accommodationId: 6, name: 'Vila Depresija'}),
    (plandiste:Accommodation {accommodationId: 7, name: 'Vila na Pezosu'}),
    (alibegovac:Accommodation {accommodationId: 8, name: 'Vila na Detelinari'}),
    (dedinje:Accommodation {accommodationId: 9, name: 'Vila 1'}),
    (srbija:Accommodation {accommodationId: 10, name: 'Vila 2'}),
    (zlatibor:Accommodation {accommodationId: 11, name: 'Vila 3'}),
    (romanija:Accommodation {accommodationId: 12, name: 'Vila 4'}),
    (vila:Accommodation {accommodationId: 13, name: 'Vila 5'}),
